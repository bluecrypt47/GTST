...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create Type</h1>
                            ...
                            <form method="post" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" class="user">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="submit" name="create" value="Create Type" class="btn btn-primary btn-user btn-block" />
                                    </div>
                                    <div class="col-sm-4">
                                        <label style=" visibility: hidden;"><label style="color: red; visibility: hidden;">*</label></label>
